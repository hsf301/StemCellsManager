...
public class TCControllerFullScreen extends RelativeLayout implements IController, View.OnClickListener,
    ...
    private boolean                             mHideVideoProgress;                     // 隐藏进度条
    ...
    public boolean isHideVideoProgress() {
        return mHideVideoProgress;
    }

    public void setHideVideoProgress(boolean hideVideoProgress) {
        this.mHideVideoProgress = hideVideoProgress;
    }
