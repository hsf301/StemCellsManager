...
public class ArticleDynamicFragment extends DynamicFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_dynamic_article, null);
        ...
        adapter.setOnItemClickListener(new BaseAdapter.OnItemClickListener<Dynamic>() {
            ...
            public void onItemClick(View view, Dynamic dynamic) {
                switch (view.getId()){
                    default:{
                        detailPopupwindow.show(dynamic);
                        break;
                    }
                }
            }
    ...
    private void doQuery(){
        OkGo.<JSONObject>get(HttpHelper.Url.Dynamic.dynamicList)
                ...
                .params(HttpHelper.Params.type, Constants.Type.Detail.pic)
