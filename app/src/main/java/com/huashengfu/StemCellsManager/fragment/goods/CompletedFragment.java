...
import com.huashengfu.StemCellsManager.adapter.goods.order.CompletedOrdersAdapter;
...
public class CompletedFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_goods_orders_completed, null);
        ...
        adapter = new CompletedOrdersAdapter();
    ...
    private void doQuery(){
        OkGo.<JSONObject>get(HttpHelper.Url.Order.pageList)
                ...
                .params(HttpHelper.Params.status, Constants.Status.Order.completed)
                ...
                .execute(new JsonCallback<JSONObject>() {
                    ...
                    public void onFinish() {
                        ...
                        Log.i(Constants.Log.Log, "onFinish==========1");
                        loadMoreWrapper.setLoadState(loadMoreWrapper.LOADING_COMPLETE);
                        Log.i(Constants.Log.Log, "onFinish============2");
