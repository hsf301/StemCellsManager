...
public class ActivityFinishedFragment extends ActivityFragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_activity_finished, null);
    ...
    private void doQuery(){
        OkGo.<JSONObject>get(HttpHelper.Url.Activity.pageList)
                ...
                .params(HttpHelper.Params.activityStatus, Constants.Status.Activity.finished)
