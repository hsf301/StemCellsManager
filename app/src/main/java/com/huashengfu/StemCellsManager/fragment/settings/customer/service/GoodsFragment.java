...
public class GoodsFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_settings_customer_service_goods, null);
        ...
        adapter = new TelePhoneAdapter(this, Constants.Type.CustomerService.goods);
    ...
    private void doQuery(){
        OkGo.<JSONObject>get(HttpHelper.Url.Store.customerServicesList)
                ...
                .params(HttpHelper.Params.type, Constants.Type.CustomerService.goods)
