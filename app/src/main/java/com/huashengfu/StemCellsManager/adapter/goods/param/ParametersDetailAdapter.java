...
public class ParametersDetailAdapter extends BaseAdapter<ParametersDetailViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_goods_parameters_detail, parent, false);
        ParametersDetailViewHolder viewHolder = new ParametersDetailViewHolder(view);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ParametersDetailViewHolder viewHolder = (ParametersDetailViewHolder) holder;
