...
// 发布新活动-Banner
public class PublishActivityBannerActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activity_publish_banner);
                ...
                OkGo.<JSONObject>post(HttpHelper.Url.Activity.Details.uploadBanner)
                        ...
                        .execute(new DialogCallback<JSONObject>(this, false) {
                            ...
                            public void onSuccess(Response<JSONObject> response) {
                                ...
                                try {
                                    if(ResponseUtils.ok(response.body())){
                                        String url = response.body().getString(Constants.Tag.data);

                                        showMessage(R.string.success_service_process_add);

                                        Intent intent = new Intent(getApplicationContext(), PublishActivityInformactionActivity.class);
                                        intent.putExtra(Constants.Tag.data, url);
        ...
        for(int i=0; i<photoRelativeLayout.size(); i++) {
            ...
            imageView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    AlertDialog dialog = new AlertDialog.Builder(PublishActivityBannerActivity.this)
        ...
        private void init() {
            ...
            popupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
                ...
                public void onDismiss() {
                    ViewUtils.background(PublishActivityBannerActivity.this, 1f);
                }
            });
            ...
            rxPermissions.requestEachCombined(new String[]{
                    ...
                    .subscribe(permission -> {
                        if(permission.granted){
                            ViewUtils.background(PublishActivityBannerActivity.this, 0.8f);
