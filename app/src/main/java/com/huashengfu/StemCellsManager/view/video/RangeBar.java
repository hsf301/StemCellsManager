package com.huashengfu.StemCellsManager.view.video;
...
public class RangeBar extends View {
    ...
    private static final int DEFAULT_THUMB_IMAGE_NORMAL = R.mipmap.icon_handle_left;
    private static final int DEFAULT_THUMB_IMAGE_PRESSED = R.mipmap.icon_handle_left;
    ...
    // setTickCount only resets indices before progress thumb has been pressed or progress
    ...
    /**
     * Sets progress listener to receive notifications of changes to the RangeBar. This
    ...
    /**
     * If this is set, the thumb images will be replaced with progress circle of the
    ...
    /**
     * Sets the normal thumb picture by taking in progress reference ID to an image.
     *
    ...
    /**
     * Sets the pressed thumb picture by taking in progress reference ID to an image.
     *
    ...
    /**
     * If this is set, the thumb images will be replaced with progress circle. The
    ...
    /**
     * Creates progress new ConnectingLine.
     *
     * @param
     */
    ...
    /**
     * Handles progress {@link MotionEvent#ACTION_DOWN} event.
     *
    ...
    /**
     * Handles progress {@link MotionEvent#ACTION_UP} or
    ...
    /**
     * Handles progress {@link MotionEvent#ACTION_MOVE} event.
     *
